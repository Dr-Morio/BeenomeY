...
public class BeenomeyItemModelProvider extends ItemModelProvider{
	...
	protected void registerModels() {
		...
		simpleBee(BeeInit.COMMON_BEE, "coal",		    "bee_base_0", "bee_body_color_0");
		...
		simpleBee(BeeInit.COMMON_BEE, "nether_wart",	"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "soul_sand",		"bee_base_0", "bee_body_color_0");
		...
		simpleBee(BeeInit.COMMON_BEE, "lapis_lazuli",	"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "redstone",		"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "iron",		    "bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "gold",		    "bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "copper",		    "bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "diamond",		"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "obsidian",		"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "glowstone",		"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "blaze",		    "bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "emerald",		"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "nether_star",	"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "nether_quarz",	"bee_base_0", "bee_body_color_0");
		...
		simpleBee(BeeInit.COMMON_BEE, "netherite",		"bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "exp",		    "bee_base_0", "bee_body_color_0");
		simpleBee(BeeInit.COMMON_BEE, "ender_pearl",	"bee_base_0", "bee_body_color_0");
		...
		simplePrincess(BeeInit.COMMON_BEE, "coal",		    "bee_base_0", "bee_body_color_0", "princess");
		...
		simplePrincess(BeeInit.COMMON_BEE, "nether_wart",	"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "soul_sand",		"bee_base_0", "bee_body_color_0", "princess");
		...
		simplePrincess(BeeInit.COMMON_BEE, "lapis_lazuli",	"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "redstone",		"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "iron",		    "bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "gold",		    "bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "copper",		"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "diamond",		"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "obsidian",		"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "glowstone",		"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "blaze",		    "bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "emerald",		"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "nether_star",	"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "nether_quarz",	"bee_base_0", "bee_body_color_0", "princess");
		...
		simplePrincess(BeeInit.COMMON_BEE, "netherite",		"bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "exp",		    "bee_base_0", "bee_body_color_0", "princess");
		simplePrincess(BeeInit.COMMON_BEE, "ender_pearl",	"bee_base_0", "bee_body_color_0", "princess");
